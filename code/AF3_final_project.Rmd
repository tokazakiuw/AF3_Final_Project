...
_Percentage of Cardiovascular Heart Diseases = 2.634 + Coronary Heart Disease * 3.906 + Diseases of the Heart * 15.069 + Heart Failure * 2.067 + Major Cardiovascular Disease * 20.930 + Stroke * 0.885 + Age 75+ * 0.488_
...
The adjusted r squared for this model is `r rsquared`, in this case, about 31.6% of the data from age and cardiovascular heart diseases is explained by the linear model. 
