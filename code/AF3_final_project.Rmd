...
**Null Hypothesis**: Gender has no influence on a patient's susceptibility for high rates of heart failure related hospitalizations. The proportion between Genders for high rates of heart failure related hospitalizations are equal (proportion Male=proportion Female; 0.5=0.5) .

**Alternative Hypothesis**: Gender will influence a patient's susceptibility for high rates of heart failure related hospitalizations. Specifically, Males will be adversely impacted by high rates of heart failure related hospitalizations in proportion to Females. The proportion of Males for high rates of heart failure related hospitalizations are greater than Females (proportion Male\>proportion Female).
...
## Get the observed difference of proportion of yes to high rates of heart failure hospitalizations based on Gender
```
