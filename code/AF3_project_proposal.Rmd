...
## Summarize the mean, median, IQR, and sd by Age and Percentage
gender_stats_percentage <- cms_data %>% 
...
## Summarize the mean, median, IQR, and sd by Gender and Percentage
gender_stats_percentage <- cms_data %>% 
...
## Summarize the mean, median, IQR, and sd by Race and Percentage
race_stats_percentage <- cms_data %>% 
  filter(Break_Out_Category == "Race", Data_Value_Unit=="Percent (%)") %>% 
  filter(!is.na(Break_Out), !is.na(Data_Value)) %>% 
  group_by(Break_Out) %>% 
  summarize(
    mean_value = mean(Data_Value),
